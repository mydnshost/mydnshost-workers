			...
			if (RedisLock::acquireLock('zone_' . $domain->getDomainRaw())) {
				...
				if (empty($keys)) {
					if ($generateIfMissing) {
						...
						$this->getTaskServer()->runBackgroundJob(new JobInfo('', 'bind_create_keys', ['domain' => $domain->getDomainRaw(), 'ifmissing' => true], 'No DNSSEC keys found, generating', $this->getCurrentJobId()));
					} else {
